class CsvController < ApplicationController
  ...
  def download_accepted
    ...
    send_data submissions_accepted_csv, filename: 'accepted.csv', type: "text/csv; charset=UTF-8;"
  end
  ...
  def download_waitlist
    ...
    send_data submissions_waitlist_csv, filename: 'waitlist.csv', type: "text/csv; charset=UTF-8;"
  end
  ...
  def download_unaccepted
    ...
    send_data submissions_unaccepted_csv, filename: 'unaccepted.csv', type: "text/csv; charset=UTF-8;"
  end
end
